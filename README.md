...
### Now
- Building Claude plugins for the aiocean.io AI platform
- Security hardening (TruffleHog scanning) across Go MCP servers (jira, gitlab, google-chat)
- Distributing Go MCP tools via Homebrew tap
